...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_SpinLock | typedef | - | - | .NET has System.Threading.Interlocked |
...
| SDL_GetAudioStreamDevice | function | Audio.SDL_GetAudioStreamDevice | - | Deferred |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_SetError | function | Error.SDL_SetError | - | Used internally by native layer |
| SDL_SetErrorV | function | - | - | Variadic: C va_list has no safe C# equivalent |
| SDL_OutOfMemory | function | Error.SDL_OutOfMemory | - | Used internally |
| SDL_GetError | function | Error.SDL_GetError | SdlException | |
| SDL_ClearError | function | Error.SDL_ClearError | SdlException | |
| SDL_Unsupported | macro | Error.SDL_Unsupported | - | Used internally |
| SDL_InvalidParamError | macro | Error.SDL_InvalidParamError | - | Used internally |
...
| SDL_PumpEvents | function | Events.SDL_PumpEvents | - | Used internally by Application |
| SDL_PollEvent | function | Events.SDL_PollEvent | - | Used internally by Application |
| SDL_WaitEvent | function | Events.SDL_WaitEvent | - | Used internally by Application |
| SDL_WaitEventTimeout | function | Events.SDL_WaitEventTimeout | - | Used internally by Application |
| SDL_PushEvent | function | Events.SDL_PushEvent | - | Used internally |
| SDL_HasEvent | function | Events.SDL_HasEvent | - | Used internally |
| SDL_HasEvents | function | Events.SDL_HasEvents | - | Used internally |
| SDL_FlushEvent | function | Events.SDL_FlushEvent | - | Used internally |
| SDL_FlushEvents | function | Events.SDL_FlushEvents | - | Used internally |
| SDL_SetEventEnabled | function | Events.SDL_SetEventEnabled | - | Used internally |
| SDL_EventEnabled | function | Events.SDL_EventEnabled | - | Used internally |
| SDL_RegisterEvents | function | Events.SDL_RegisterEvents | - | Used internally |
| SDL_PeepEvents | function | - | - | Deferred: complex callback interop |
...
| SDL_EnumerateDirectory | function | - | - | Deferred: callback-based enumeration |
| SDL_GlobDirectory | function | - | - | Deferred: .NET has Directory.GetFiles |
| SDL_GetPathInfo | function | - | - | Deferred: .NET has FileInfo |
| SDL_RemovePath | function | - | - | Deferred: .NET has File.Delete |
...
| SDL_GPULoadOp | enum | Gpu.SDL_GPULoadOp | - | Used internally by GpuRenderPass |
| SDL_GPUStoreOp | enum | Gpu.SDL_GPUStoreOp | - | Used internally by GpuRenderPass |
...
| SDL_GPUCubeMapFace | enum | Gpu.SDL_GPUCubeMapFace | - | Used internally |
| SDL_GPUTransferBufferUsage | enum | Gpu.SDL_GPUTransferBufferUsage | - | Used internally |
| SDL_GPUShaderStage | enum | Gpu.SDL_GPUShaderStage | - | Used internally |
| SDL_GPUVertexElementFormat | enum | Gpu.SDL_GPUVertexElementFormat | - | Used internally by pipeline creation |
| SDL_GPUVertexInputRate | enum | Gpu.SDL_GPUVertexInputRate | - | Used internally by pipeline creation |
| SDL_GPUFillMode | enum | Gpu.SDL_GPUFillMode | - | Used internally by pipeline creation |
| SDL_GPUCullMode | enum | Gpu.SDL_GPUCullMode | - | Used internally by pipeline creation |
| SDL_GPUFrontFace | enum | Gpu.SDL_GPUFrontFace | - | Used internally by pipeline creation |
| SDL_GPUCompareOp | enum | Gpu.SDL_GPUCompareOp | - | Used internally by pipeline creation |
| SDL_GPUStencilOp | enum | Gpu.SDL_GPUStencilOp | - | Used internally by pipeline creation |
| SDL_GPUBlendOp | enum | Gpu.SDL_GPUBlendOp | - | Used internally by pipeline creation |
| SDL_GPUBlendFactor | enum | Gpu.SDL_GPUBlendFactor | - | Used internally by pipeline creation |
| SDL_GPUFilter | enum | Gpu.SDL_GPUFilter | - | Used internally by sampler creation |
| SDL_GPUSamplerMipmapMode | enum | Gpu.SDL_GPUSamplerMipmapMode | - | Used internally by sampler creation |
| SDL_GPUSamplerAddressMode | enum | Gpu.SDL_GPUSamplerAddressMode | - | Used internally by sampler creation |
...
| SDL_GPUColorComponentFlags | flags | Gpu.SDL_GPUColorComponentFlags | - | Used internally by blend state |
| SDL_GPUViewport | struct | Gpu.SDL_GPUViewport | - | Used internally |
| SDL_GPUTextureTransferInfo | struct | Gpu.SDL_GPUTextureTransferInfo | - | Used internally |
| SDL_GPUTransferBufferLocation | struct | Gpu.SDL_GPUTransferBufferLocation | - | Used internally |
| SDL_GPUTextureLocation | struct | Gpu.SDL_GPUTextureLocation | - | Used internally |
| SDL_GPUTextureRegion | struct | Gpu.SDL_GPUTextureRegion | - | Used internally |
| SDL_GPUBlitRegion | struct | Gpu.SDL_GPUBlitRegion | - | Used internally |
| SDL_GPUBufferLocation | struct | Gpu.SDL_GPUBufferLocation | - | Used internally |
| SDL_GPUBufferRegion | struct | Gpu.SDL_GPUBufferRegion | - | Used internally |
| SDL_GPUIndirectDrawCommand | struct | Gpu.SDL_GPUIndirectDrawCommand | - | Used internally |
| SDL_GPUIndexedIndirectDrawCommand | struct | Gpu.SDL_GPUIndexedIndirectDrawCommand | - | Used internally |
| SDL_GPUIndirectDispatchCommand | struct | Gpu.SDL_GPUIndirectDispatchCommand | - | Used internally |
| SDL_GPUSamplerCreateInfo | struct | Gpu.SDL_GPUSamplerCreateInfo | - | Used internally by GpuDevice.CreateSampler |
| SDL_GPUVertexBufferDescription | struct | Gpu.SDL_GPUVertexBufferDescription | - | Used internally |
| SDL_GPUVertexAttribute | struct | Gpu.SDL_GPUVertexAttribute | - | Used internally |
| SDL_GPUVertexInputState | struct | Gpu.SDL_GPUVertexInputState | - | Used internally |
| SDL_GPUStencilOpState | struct | Gpu.SDL_GPUStencilOpState | - | Used internally |
| SDL_GPUColorTargetBlendState | struct | Gpu.SDL_GPUColorTargetBlendState | - | Used internally |
| SDL_GPUShaderCreateInfo | struct | Gpu.SDL_GPUShaderCreateInfo | - | Used internally by GpuDevice.CreateShader |
| SDL_GPUTextureCreateInfo | struct | Gpu.SDL_GPUTextureCreateInfo | - | Used internally by GpuDevice.CreateTexture |
| SDL_GPUBufferCreateInfo | struct | Gpu.SDL_GPUBufferCreateInfo | - | Used internally by GpuDevice.CreateBuffer |
| SDL_GPUTransferBufferCreateInfo | struct | Gpu.SDL_GPUTransferBufferCreateInfo | - | Used internally |
| SDL_GPURasterizerState | struct | Gpu.SDL_GPURasterizerState | - | Used internally |
| SDL_GPUMultisampleState | struct | Gpu.SDL_GPUMultisampleState | - | Used internally |
| SDL_GPUDepthStencilState | struct | Gpu.SDL_GPUDepthStencilState | - | Used internally |
| SDL_GPUColorTargetDescription | struct | Gpu.SDL_GPUColorTargetDescription | - | Used internally |
| SDL_GPUGraphicsPipelineTargetInfo | struct | Gpu.SDL_GPUGraphicsPipelineTargetInfo | - | Used internally |
| SDL_GPUGraphicsPipelineCreateInfo | struct | Gpu.SDL_GPUGraphicsPipelineCreateInfo | - | Used internally |
| SDL_GPUComputePipelineCreateInfo | struct | Gpu.SDL_GPUComputePipelineCreateInfo | - | Used internally |
| SDL_GPUColorTargetInfo | struct | Gpu.SDL_GPUColorTargetInfo | - | Used internally |
| SDL_GPUDepthStencilTargetInfo | struct | Gpu.SDL_GPUDepthStencilTargetInfo | - | Used internally |
| SDL_GPUBlitInfo | struct | Gpu.SDL_GPUBlitInfo | - | Used internally |
| SDL_GPUBufferBinding | struct | Gpu.SDL_GPUBufferBinding | - | Used internally |
| SDL_GPUTextureSamplerBinding | struct | Gpu.SDL_GPUTextureSamplerBinding | - | Used internally |
| SDL_GPUStorageBufferReadWriteBinding | struct | Gpu.SDL_GPUStorageBufferReadWriteBinding | - | Used internally |
| SDL_GPUStorageTextureReadWriteBinding | struct | Gpu.SDL_GPUStorageTextureReadWriteBinding | - | Used internally |
| SDL_GPUSupportsShaderFormats | function | Gpu.SDL_GPUSupportsShaderFormats | - | Used internally |
| SDL_CreateGPUDevice | function | Gpu.SDL_CreateGPUDevice | GpuDevice.Create | |
| SDL_CreateGPUDeviceWithProperties | function | Gpu.SDL_CreateGPUDeviceWithProperties | - | Used internally |
...
| SDL_BindGPUGraphicsPipeline | function | Gpu.SDL_BindGPUGraphicsPipeline | GpuRenderPass.BindPipeline | |
...
| SDL_UploadToGPUTexture | function | Gpu.SDL_UploadToGPUTexture | GpuCopyPass.UploadTexture | |
| SDL_UploadToGPUBuffer | function | Gpu.SDL_UploadToGPUBuffer | GpuCopyPass.UploadBuffer | |
...
| SDL_DownloadFromGPUTexture | function | Gpu.SDL_DownloadFromGPUTexture | GpuCopyPass.DownloadTexture | |
| SDL_DownloadFromGPUBuffer | function | Gpu.SDL_DownloadFromGPUBuffer | GpuCopyPass.DownloadBuffer | |
...
| SDL_WindowSupportsGPUSwapchainComposition | function | Gpu.SDL_WindowSupportsGPUSwapchainComposition | - | Deferred managed wrapper |
| SDL_WindowSupportsGPUPresentMode | function | Gpu.SDL_WindowSupportsGPUPresentMode | - | Deferred managed wrapper |
...
| SDL_WaitForGPUFences | function | Gpu.SDL_WaitForGPUFences | GpuFence.WaitAll | |
| SDL_QueryGPUFence | function | Gpu.SDL_QueryGPUFence | GpuFence.Query | |
| SDL_ReleaseGPUFence | function | Gpu.SDL_ReleaseGPUFence | GpuFence.Dispose | |
| SDL_GPUTextureFormatTexelBlockSize | function | Gpu.SDL_GPUTextureFormatTexelBlockSize | - | Deferred managed wrapper |
...
| SDL_CalculateGPUTextureFormatSize | function | Gpu.SDL_CalculateGPUTextureFormatSize | - | Deferred managed wrapper |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_HintPriority | enum | Hints.SDL_HintPriority | - | Used internally |
| SDL_SetHintWithPriority | function | Hints.SDL_SetHintWithPriority | - | Used internally |
...
| SDL_HINT_* | macro (200+) | - | - | String constants passed via SdlHints.Set/Get |
...
| SDL_PROP_APP_METADATA_*_STRING | macro (7) | Init.SDL_PROP_APP_METADATA_*_STRING | - | Property string constants |

## SDL_iostream.h

| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_IOStream | struct | - | - | .NET has System.IO.Stream |
...
| SDL_IOFromMem | function | - | - | .NET has MemoryStream |
...
| SDL_GetJoystickPowerInfo | function | - | - | Deferred |
...
| SDL_GetKeyboardState | function | Keyboard.SDL_GetKeyboardState | Keyboard.IsKeyPressed | |
...
| SDL_SetTextInputArea | function | - | - | Deferred: needs SDL_Rect pointer |
| SDL_GetTextInputArea | function | - | - | Deferred: needs SDL_Rect pointer |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_Keycode | enum (400+ values) | Keycode.SDL_Keycode | Keycode | |
| SDL_Keymod | enum | Keycode.SDL_Keymod | KeyModifiers | |
...
| SDL_LogMessage | function | - | - | Variadic: printf-style |

## SDL_main.h

| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_main_func | typedef | - | - | App callbacks model: C# runtime owns main() |
| SDL_main | function | - | - | App callbacks model: C# runtime owns main() |
| SDL_SetMainReady | function | - | - | App callbacks model: C# runtime owns main() |
| SDL_RunApp | function | - | - | App callbacks model: C# runtime owns main() |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_MessageBoxFlags | enum | MessageBox.SDL_MessageBoxFlags | - | Used internally |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_Cursor | struct | Mouse.SDL_Cursor | - | Used internally |
| SDL_SystemCursor | enum | Mouse.SDL_SystemCursor | - | Used internally |
| SDL_MouseWheelDirection | enum | Mouse.SDL_MouseWheelDirection | - | Used internally |
| SDL_BUTTON_LEFT | macro | Mouse.SDL_BUTTON_LEFT | - | Used internally |
| SDL_BUTTON_MIDDLE | macro | Mouse.SDL_BUTTON_MIDDLE | - | Used internally |
| SDL_BUTTON_RIGHT | macro | Mouse.SDL_BUTTON_RIGHT | - | Used internally |
| SDL_BUTTON_X1 | macro | Mouse.SDL_BUTTON_X1 | - | Used internally |
| SDL_BUTTON_X2 | macro | Mouse.SDL_BUTTON_X2 | - | Used internally |
...
| SDL_SetRelativeMouseTransform | function | - | - | Niche: callback-based, complex interop |
...
| SDL_SetPointerPropertyWithCleanup | function | - | - | Unsafe: raw pointer with cleanup callback |
| SDL_SetPointerProperty | function | - | - | Unsafe: raw pointer property |
...
| SDL_GetPointerProperty | function | Properties.SDL_GetPointerProperty | - | Unsafe: raw pointer property |
...
| SDL_RectToFRect | function | - | - | Inline: SDL_FORCE_INLINE, not exported |
...
| SDL_CreateWindowAndRenderer | function | Render.SDL_CreateWindowAndRenderer | - | Deferred managed wrapper |
...
| SDL_CreateTexture | function | Render.SDL_CreateTexture | Texture.Create | |
| SDL_CreateTextureFromSurface | function | Render.SDL_CreateTextureFromSurface | Texture.Create | |
...
| SDL_SetRenderLogicalPresentation | function | Render.SDL_SetRenderLogicalPresentation | Renderer.LogicalPresentation | |
| SDL_GetRenderLogicalPresentation | function | Render.SDL_GetRenderLogicalPresentation | Renderer.LogicalPresentation | |
...
| SDL_SetRenderDrawColorFloat | function | Render.SDL_SetRenderDrawColorFloat | Renderer.DrawColor | |
| SDL_GetRenderDrawColor | function | Render.SDL_GetRenderDrawColor | Renderer.DrawColor | |
| SDL_GetRenderDrawColorFloat | function | Render.SDL_GetRenderDrawColorFloat | Renderer.DrawColor | |
...
| SDL_RenderPoint | function | Render.SDL_RenderPoint | Renderer.Point | |
| SDL_RenderPoints | function | Render.SDL_RenderPoints | Renderer.Points | |
| SDL_RenderLine | function | Render.SDL_RenderLine | Renderer.Line | |
| SDL_RenderLines | function | Render.SDL_RenderLines | Renderer.Lines | |
| SDL_RenderRect | function | Render.SDL_RenderRect | Renderer.Rect | |
| SDL_RenderRects | function | Render.SDL_RenderRects | Renderer.Rects | |
...
| SDL_RenderTexture | function | Render.SDL_RenderTexture | Renderer.Texture | |
| SDL_RenderTextureRotated | function | Render.SDL_RenderTextureRotated | Renderer.TextureRotated | |
| SDL_RenderTextureAffine | function | Render.SDL_RenderTextureAffine | Renderer.TextureAffine | |
| SDL_RenderTextureTiled | function | Render.SDL_RenderTextureTiled | Renderer.TextureTiled | |
| SDL_RenderTexture9Grid | function | Render.SDL_RenderTexture9Grid | Renderer.Texture9Grid | |
| SDL_RenderTexture9GridTiled | function | - | - | Deferred |
| SDL_RenderGeometry | function | Render.SDL_RenderGeometry | Renderer.Geometry | |
| SDL_RenderGeometryRaw | function | Render.SDL_RenderGeometryRaw | Renderer.GeometryRaw | |
...
| SDL_ConvertEventToRenderCoordinates | function | - | - | Deferred: needs SDL_Event |
...
| SDL_RenderDebugText | function | Render.SDL_RenderDebugText | Renderer.DebugText | |
| SDL_RenderDebugTextFormat | function | - | - | Variadic: printf-style, use RenderDebugText + C# formatting |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_malloc / SDL_free / SDL_realloc | function | - | - | .NET has managed memory + Marshal.AllocHGlobal |
| SDL_memset / SDL_memcpy / SDL_memmove | function | - | - | .NET has Buffer.MemoryCopy, Span<T> |
| SDL_strlen / SDL_strcmp / SDL_strcpy | function | - | - | .NET has System.String |
| SDL_atoi / SDL_atof / SDL_itoa | function | - | - | .NET has int.Parse, ToString |
| ... | (100+ utility functions) | - | - | .NET has built-in equivalents for all |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_SurfaceFlags | enum | Surface.SDL_SurfaceFlags | - | Used internally |
...
| SDL_IsTablet | function | - | - | Platform: mobile-specific |
| SDL_IsTV | function | - | - | Platform: TV-specific |
| SDL_GetSandbox | function | - | - | Platform: sandbox detection |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_TimerID | typedef | Timer.SDL_TimerID | - | Used internally |
...
| SDL_TimerCallback | callback | - | - | Deferred: callback-based timers |
| SDL_AddTimer | function | - | - | Deferred: callback-based timers |
| SDL_NSTimerCallback | callback | - | - | Deferred: callback-based timers |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_Tray | struct | - | - | Niche: system tray API, desktop-specific |
| SDL_TrayMenu | struct | - | - | Niche: system tray |
| SDL_TrayEntry | struct | - | - | Niche: system tray |
| SDL_CreateTray | function | - | - | Niche: system tray |
| SDL_SetTrayIcon | function | - | - | Niche: system tray |
| SDL_SetTrayTooltip | function | - | - | Niche: system tray |
| SDL_CreateTrayMenu | function | - | - | Niche: system tray |
| SDL_DestroyTray | function | - | - | Niche: system tray |
...
| SDL_GetDesktopDisplayMode | function | Video.SDL_GetDesktopDisplayMode | Display.DesktopMode | |
| SDL_GetCurrentDisplayMode | function | Video.SDL_GetCurrentDisplayMode | Display.CurrentMode | |
| SDL_GetDisplayForWindow | function | Video.SDL_GetDisplayForWindow | Window.Display | |
...
| SDL_SetWindowIcon | function | Video.SDL_SetWindowIcon | Window.Icon | |
...
| SDL_SetWindowBordered | function | Video.SDL_SetWindowBordered | Window.Bordered | |
| SDL_SetWindowResizable | function | Video.SDL_SetWindowResizable | Window.Resizable | |
| SDL_SetWindowFullscreen | function | Video.SDL_SetWindowFullscreen | Window.Fullscreen | |
...
| SDL_GetWindowSurface | function | Video.SDL_GetWindowSurface | Window.Surface | |
| SDL_UpdateWindowSurface | function | Video.SDL_UpdateWindowSurface | Window.UpdateSurface | |
| SDL_DestroyWindowSurface | function | Video.SDL_DestroyWindowSurface | Window.DestroySurface | |
...
| SDL_SetWindowFillDocument | function | - | - | Deferred |
...
| SDL_ProgressState | typedef | - | - | Deferred: progress state |
...
| SDL Symbol | Kind | Native Wrapper | Managed Wrapper | Notes |
|---|---|---|---|---|
| SDL_Vulkan_LoadLibrary | function | - | - | Niche: use Silk.NET or Vortice for Vulkan |
| SDL_Vulkan_GetVkGetInstanceProcAddr | function | - | - | Niche: Vulkan interop |
| SDL_Vulkan_UnloadLibrary | function | - | - | Niche: Vulkan interop |
| SDL_Vulkan_GetInstanceExtensions | function | - | - | Niche: Vulkan interop |
| SDL_Vulkan_CreateSurface | function | - | - | Niche: Vulkan interop |
| SDL_Vulkan_DestroySurface | function | - | - | Niche: Vulkan interop |
| SDL_Vulkan_GetPresentationSupport | function | - | - | Niche: Vulkan interop |

---

*Headers not listed (SDL_begin_code.h, SDL_close_code.h, SDL_copying.h, SDL_dlopennote.h, SDL_egl.h, SDL_endian.h, SDL_intrin.h, SDL_main_impl.h, SDL_oldnames.h, SDL_opengl*.h, SDL_opengles*.h, SDL_platform_defines.h, SDL_revision.h, SDL_test*.h) contain no public API relevant to wrapping.*
