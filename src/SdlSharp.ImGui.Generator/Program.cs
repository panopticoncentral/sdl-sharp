...
// Write assembly attributes file (required for LibraryImport with struct wrappers)
var assemblyAttributesContent = """
    // <auto-generated>
    ...
    """;
File.WriteAllText(Path.Combine(outputDir, "AssemblyAttributes.cs"), assemblyAttributesContent);

// Write shared native library constants
var nativeLibraryContent = $$"""
    // <auto-generated>
    // This file was generated by SdlSharp.ImGui.Generator
    // Do not modify this file directly.
    // </auto-generated>
    ...
    internal static class NativeLibrary
    {
        ...
        /// </summary>
        public const string Name = "SdlSharp.ImGui.Native";
    }
    """;
File.WriteAllText(Path.Combine(outputDir, "NativeLibrary.cs"), nativeLibraryContent);
...
foreach (var handleName in TypedefGenerator.OpaqueHandleTypedefs)
{
    ...
    .Where(s => !TypeMapper.IsUnsupportedType(s)))
{
    ...
    structMethodsByClass.TryGetValue(structInfo.Name, out var methods);
