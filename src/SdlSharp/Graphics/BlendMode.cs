...
namespace SdlSharp.Graphics
{
    ...
    public readonly struct BlendMode
    {
        ...
        /// No blending.
        /// </summary>
        public static readonly BlendMode None = new BlendMode(0x00000000);

        /// <summary>
        /// Alpha blending.
        /// </summary>
        public static readonly BlendMode Blend = new BlendMode(0x00000001);

        /// <summary>
        /// Additive blending.
        /// </summary>
        public static readonly BlendMode Add = new BlendMode(0x00000002);
